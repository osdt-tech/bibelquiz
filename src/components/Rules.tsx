      ...
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <motion.div
            ...
            transition={{ delay: 0 }}
          >
            <Card className="p-6 rounded-3xl bg-gradient-to-br from-primary/5 to-primary/10">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <Cube className="w-12 h-12 text-primary" weight="duotone" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold mb-3">Ein fröhliches Frage- und Antwortspiel mit Farbwürfeln</h2>
          ...
          >
            <Card className="p-6 rounded-3xl">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <Palette className="w-10 h-10 text-primary" weight="duotone" />
                </div>
                <div className="flex-1">
                  <h2 className="text-2xl font-bold mb-4">Spielablauf</h2>
          ...
          >
            <Card className="p-6 rounded-3xl">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <Trophy className="w-10 h-10 text-primary" weight="duotone" />
                </div>
                <div className="flex-1">
                  <h2 className="text-2xl font-bold mb-4">Spielende</h2>
          ...
          >
            <Card className="p-6 rounded-3xl">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0">
                  <Users className="w-10 h-10 text-primary" weight="duotone" />
                </div>
                <div className="flex-1">
                  <h2 className="text-2xl font-bold mb-4">Schwierigkeitsgrade der Fragen</h2>
                  <div className="space-y-4 text-muted-foreground">
                    <p className="leading-relaxed">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="bg-green-500/10 border border-green-500/20 p-4 rounded-xl text-center">
                        ...
                        <p className="font-medium">Leichte Frage</p>
                        <p className="text-sm">1 Punkt</p>
                      </div>
                      <div className="bg-yellow-500/10 border border-yellow-500/20 p-4 rounded-xl text-center">
                        ...
                        <p className="font-medium">Mittelschwere Frage</p>
                        <p className="text-sm">2 Punkte</p>
                      </div>
                      <div className="bg-red-500/10 border border-red-500/20 p-4 rounded-xl text-center">
                        <div className="text-4xl font-bold text-red-600 mb-2">3</div>
                        <p className="font-medium">Schwere Frage</p>
                        <p className="text-sm">3 Punkte</p>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          >
            <Card className="p-6 rounded-3xl bg-gradient-to-br from-secondary/20 to-secondary/5">
              <h2 className="text-2xl font-bold mb-4">Variationsmöglichkeiten</h2>
              <div className="space-y-4 text-muted-foreground">
                <p className="leading-relaxed">
          ...
          >
            <Card className="p-6 rounded-3xl text-center bg-gradient-to-r from-primary/10 to-primary/20">
